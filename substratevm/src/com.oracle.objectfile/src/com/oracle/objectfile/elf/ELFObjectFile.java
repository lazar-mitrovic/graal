...
public class ELFObjectFile extends ObjectFile {
    ...
    public ELFObjectFile(int pageSize, boolean runtimeDebugInfoGeneration) {
        this(pageSize, System.getProperty("svm.targetArch") == null ? ELFMachine.from(ImageSingletons.lookup(Platform.class).getArchitecture())
                        : ELFMachine.from(System.getProperty("svm.targetArch")), runtimeDebugInfoGeneration);
    }
